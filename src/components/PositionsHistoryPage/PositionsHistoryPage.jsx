import './PositionsHistoryPage.css'
...
const PositionsHistoryPage = () => {
    ...
    return (
        <div className='positions-history-page'>
            ...
            <div className="equipment-cards-wrap">
                {
                    equipment.map((item, index) => {
                        ...
                        return (
                            <Link to={`/positions/${item.name}`} key={index} style={{display: checkFilter([index, item])}}>
...
export default PositionsHistoryPage